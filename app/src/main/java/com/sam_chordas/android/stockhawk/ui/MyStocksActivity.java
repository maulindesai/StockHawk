...
public class MyStocksActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>{
    ...
    recyclerView.addOnItemTouchListener(new RecyclerViewItemClickListener(this,
            new RecyclerViewItemClickListener.OnItemClickListener() {
              @Override public void onItemClick(View v, int position) {
                String selected_symbol= getSelectedQuoteSymbol(mCursorAdapter.getCursor(),position);
                Intent intent=new Intent(MyStocksActivity.this,StockHistoryActivity.class);
                intent.putExtra(StockHistoryActivity.EXTRA_SYMBOL_NAME,selected_symbol);
  ...
  /**
   * get selected quote from cursor done by mcd
   * @param cursor adapter cursor
   * @param position user selected position
   * @return
     */
  private String getSelectedQuoteSymbol(Cursor cursor,int position) {
    cursor.moveToFirst();
    cursor.move(position);
    String selected_symbole=cursor.getString(cursor.getColumnIndex(QuoteColumns.SYMBOL));
    cursor.close();
    return selected_symbole;
  }
  ...
  public void onResume() {
    ...
    filter.addAction(StockIntentService.StockIntentAction);
